...
exports.list_all_tasks =  function (req, res) {
 ...
 console.log(" response2 = ",response2);
  ...
  if (err) {
    res.json({ message: 'Selected but Mail not sended and Error is'+err });
    console.log("Sendgrid Mail error",err);
    console.log("Sendgrid Mail error wwwww "+err);
 
  } else {
    console.log("Sendgrid Success Mail sended From Azure ");
    res.json({ message: 'Selected and Mail sended' });
  }
});

  //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
