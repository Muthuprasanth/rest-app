...
function sendMail(emails,response)
{
 ...
 // console.log("email username and password",sendgridCredentials);
  ...
  let htmlstart="<!DOCTYPE html> <html><head><style> body { border:2px solid grey; padding:10px; }"
  ...
  let content = "<span> Hi ,&lt;CandidateName&gt; <span> <br> <span>Greetings from Sirius India !!</span> <br><br>"+       
  "<p>Thank you for your interest with Sirius Computer Solutions. You have been shortlisted for the  &lt;.NET and Azure Developer&gt;. Your next round is Technical Interview with our Hiring-Bot.</p><br>"+
  ...
  /*   attachments: 
        {
          content: Buffer,
          type : 'image/jpeg',
          filename: '/images/sirius_logo.png',     
        //  path: "/images",     
